...
export const uk: TranslationMap = {
  ...
  sessionsView: {
    ...
    deleteAllArchivedConfirm: "Видалити {count} архівованих гілок і їхні транскрипти?",
  ...
  configView: {
    ...
    syncedHint: "Синхронізується між вашими пристроями через gateway.",
    notifications: {
  ...
  execApproval: {
    ...
    reviewRequest: "Розгляньте підтвердження від {agent}: {command}",
  ...
  custodian: {
    ...
    history: {
      button: "Історія",
      title: "Останні зміни",
      description: "Що змінилося в цій системі, найновіші спершу.",
      ...
      loadingMore: "Завантаження додаткових…",
  ...
  mcpServers: {
    ...
    adminRequired: "Зміни сервера MCP потребують доступу operator.admin.",
    enable: "Увімкніть",
    disable: "Вимкнути",
  ...
  appsPage: {
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Огляд чатів і швидкі відповіді просто із зап'ястя.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  profilePage: {
    ...
    identity: {
      ...
      loading: "Завантаження вашого профілю…",
  ...
  board: {
    ...
    emptyHint: "Ваш агент може закріпити тут віджети — спробуйте запитати картку статусу.",
    ...
    widget: {
      ...
      frameAuthorizationFailed: "Авторизація віджета не вдалася після повторних спроб оновлення.",
      errorTitle: "Не вдалося завантажити цей віджет",
      errorDetail: "Проблема обмежена лише цією карткою.",
  ...
  chat: {
    ...
    questions: {
      ...
      answered: "Відповідь отримано",
      answeredElsewhere: "Отримано відповідь в іншому місці",
      unavailable: "Недоступно",
      expired: "Застарів",
      cancelled: "Скасовано",
    },
    ...
    composer: {
      ...
      dictationFinalizationTimedOut:
        "Диктування зупинено до того, як останній частковий транскрипт було остаточно оброблено.",
    ...
    toolCards: {
      ...
      widgetExportRerender: "Цей віджет потрібно повторно відрендерити для експорту як зображення.",
