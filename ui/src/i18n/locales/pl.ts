...
export const pl: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Nie usunięto żadnej zapisanej sesji WhatsApp. Może jej już nie być lub jej katalog uwierzytelniania może wymagać ręcznego wyczyszczenia.",
    },
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint: "JPEG, PNG lub WebP. Obrazy są przycinane od środka i skalowane do 512 px.",
      ...
      avatarTooLarge: "Przetworzony awatar jest nadal za duży.",
  ...
  configView: {
    ...
    syncedHint: "Zsynchronizowane na Twoich urządzeniach przez Gateway.",
    notifications: {
  ...
  custodian: {
    ...
    history: {
      ...
      description: "Co się zmieniło w tym systemie, od najnowszych.",
    ...
    nudge: {
      configReload:
        "Ponowne wczytanie konfiguracji zostało zatrzymane — zapytaj mnie, co się stało",
  ...
  labsPage: {
    ...
    sectionDescription:
      "Zmiany są zapisywane natychmiast i obowiązują dla przyszłych uruchomień agenta.",
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Pozwól agentom łączyć narzędzia w kompaktowe, izolowane przepływy pracy w JavaScript.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    heroTagline:
      "Aplikacje towarzyszące na telefon, zegarek, komputer i przeglądarkę — a także pluginy rozszerzające możliwości Twojego agenta.",
    ...
    cards: {
      ...
      linux: {
        title: "Linux",
        desc: "Natywna aplikacja desktopowa — pakiety .deb i AppImage.",
      },
      chrome: {
      ...
      plugins: {
        ...
        desc: "Rozszerz OpenClaw o kanały, narzędzia i skille od społeczności.",
      },
    },
  },
  presence: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      profileUnavailable: "Nie udało się wczytać profilu Twojej tożsamości.",
      avatar: "Awatar",
      avatarDescription: "PNG, JPEG lub WebP. Obrazy są przeskalowywane do 256 × 256 lub mniej.",
      chooseAvatar: "Wybierz obraz",
      processingAvatar: "Przetwarzanie…",
      displayName: "Nazwa wyświetlana",
      displayNameDescription: "Widoczna dla innych osób korzystających z tego gateway.",
  ...
  board: {
    ...
    emptyTitle: "Czysty panel, gotowy do pracy",
  ...
  chat: {
    ...
    messages: {
      ...
      forkUnavailable: "Rozgałęzienie jest niedostępne, gdy agent pracuje",
    ...
    composer: {
      ...
      dictationFinalizationTimedOut:
        "Dyktowanie zatrzymano, zanim można było sfinalizować ostatnią częściową transkrypcję.",
      ...
      selectedCameraUnavailable:
        "Wybrana kamera jest niedostępna. Wybierz inną kamerę lub ustawienie domyślne systemu.",
