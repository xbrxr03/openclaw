...
export const tr: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Depolanmış WhatsApp oturumu temizlenmedi. Zaten yok olabilir veya kimlik doğrulama dizininin manuel olarak temizlenmesi gerekebilir.",
    },
  ...
  sessionsView: {
    ...
    deleteAllArchivedConfirm: "{count} arşivlenmiş konu ve bunların dökümleri silinsin mi?",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "OpenClaw için bildirimler macOS'ta devre dışı. Sistem Ayarları > Bildirimler bölümünden izin verin.",
    },
    appearance: {
      theme: "Tema",
  ...
  execApproval: {
    ...
    reviewRequest: "{agent} kaynağından onayı inceleyin: {command}",
  ...
  custodian: {
    ...
    sessionRestarted:
      "{error} OpenClaw yeni bir oturum başlattı; önceki mesajlar bağlam için korunur.",
    ...
    nudge: {
      ...
      channelAuth: "{channel} kimlik doğrulaması zayıfladı — bana ne olduğunu sorun",
      channelDisconnected: "{channel} az önce bağlantısı kesildi — ne olduğunu bana sor",
      channelDegraded: "{channel} bozuldu — ne olduğunu bana sor",
  ...
  mcpServers: {
    ...
    nameInvalid: "Sunucu adları harf, sayı, nokta, tire veya alt çizgi kullanır.",
    targetInvalid: "HTTP taşımaları için bir URL veya stdio için geçerli bir komut satırı girin.",
    nameTaken: "“{name}” adında bir MCP sunucusu zaten var.",
  ...
  mcpPage: {
    connectorsLink: "Eklentiler sayfasında tek tıkla bağlanan konektörleri keşfedin.",
    servers: "Sunucular",
    oauth: "OAuth",
  ...
  labsPage: {
    ...
    sectionDescription:
      "Değişiklikler anında kaydedilir ve gelecekteki agent çalıştırmalarına uygulanır.",
    documentation: "Belgeler",
    restartRequired: "Gateway'in yeniden başlatılması gerekir.",
    saveErrorTitle: "Özellik güncellenemedi",
    saveFailed: "Özellik ayarı kaydedilemedi.",
    codeMode: {
      title: "Code Mode",
      description:
        "Agent'ların araçları kompakt, korumalı JavaScript iş akışlarında birleştirmesine izin verin.",
    },
    swarm: {
      title: "Swarm",
      description: "Code Mode'un alt agent gruplarını paralel olarak düzenlemesine izin verin.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      chrome: {
        ...
        desc: "OpenClaw'ın mevcut Chrome'unuzu kullanmasını sağlayın — sekmeler, sayfalar ve formlar.",
      },
      plugins: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatarErrors: {
        invalid: "Bu görüntü işlenemedi.",
        sourceTooLarge: "10 MB veya daha küçük bir görüntü seçin.",
  ...
  chat: {
    ...
    board: {
      ...
      defaultTab: "Ana",
      mockPlaceholder: "Pano görünümü ekleme yeri · {tabs} sekme · {widgets} bileşen",
    ...
    messages: {
      ...
      rewind: "Geri sar",
      rewindConfirm: "Bu mesajdan öncesine geri mi sarılsın?",
    ...
    modelControls: {
      ...
      reasoning: "Akıl yürütme",
      speed: "Hız",
      sessionOverride: "İş parçacığı geçersiz kılması",
      usingDefault: "Ayarlar'dan gelen varsayılan kullanılıyor",
    ...
    composer: {
      ...
      microphoneAppliesNextSession:
        "Değişiklikler bir sonraki Talk oturumunu başlattığınızda uygulanır.",
      ...
      holdToRecordSettingDescription:
        "Yazma alanındaki mikrofon düğmesini basılı tutun, konuşun, ardından metni göndermeden eklemek için bırakın.",
      dictationAudioUnsupported: "Gateway desteklenmeyen bir dikte ses biçimi döndürdü.",
      dictationBrowserAudioUnsupported: "Bu tarayıcı dikte sesini 8 kHz'te yakalayamıyor.",
