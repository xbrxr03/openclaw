...
export const id: TranslationMap = {
  ...
  labsPage: {
    intro:
      "Labs berisi kemampuan eksperimental yang dapat berubah, rusak, atau menghilang di antara rilis.",
    sectionTitle: "Fitur eksperimental",
    sectionDescription: "Perubahan tersimpan segera dan berlaku untuk proses agen mendatang.",
    documentation: "Dokumentasi",
    restartRequired: "Memerlukan mulai ulang Gateway.",
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Ngobrol, bicara, setujui tindakan, dan bagikan ke OpenClaw dari iOS.",
      },
      android: {
        title: "Android",
  ...
  chat: {
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Tahan tombol mikrofon pada composer, bicara, lalu lepaskan untuk menyisipkan teks tanpa mengirim.",
