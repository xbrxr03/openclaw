...
export const fa: TranslationMap = {
  ...
  quickSettings: {
    ...
    personal: {
      ...
      avatarTooLarge: "آواتار پردازش‌شده همچنان بسیار بزرگ است.",
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivityHint: "آخرین فعالیت دستیار یا ابزار را زیر جلسات در حال اجرا نمایش دهید.",
    },
    connection: {
      title: "اتصال",
      gateway: "Gateway",
  ...
  custodian: {
    ...
    sessionRestarted:
      "{error} OpenClaw یک جلسه تازه شروع کرد؛ پیام‌های پیشین برای زمینه باقی می‌مانند.",
    unsupportedGateway: "برای ادامه راه‌اندازی با OpenClaw، Gateway را به‌روزرسانی کنید.",
    history: {
      button: "تاریخچه",
      title: "تغییرات اخیر",
      description: "چه چیزی در این سیستم تغییر کرد، جدیدترین ابتدا.",
    ...
    nudge: {
      ...
      channelAuth: "احراز هویت {channel} تنزل یافت — از من بپرس چه اتفاقی افتاد",
      channelDisconnected: "{channel} همین حالا قطع شد — از من بپرس چه اتفاقی افتاد",
      channelDegraded: "{channel} تنزل یافته است — از من بپرس چه اتفاقی افتاد",
      channelFallback: "یک کانال",
      dismiss: "رد این به‌روزرسانی",
    },
  },
  mcpServers: {
    add: "افزودن سرور",
  ...
  mcpPage: {
    connectorsLink: "کانکتورهای تک‌کلیکی را در صفحهٔ Plugins کشف کنید.",
    servers: "سرورها",
    oauth: "OAuth",
    filtered: "فیلترشده",
  ...
  labsPage: {
    ...
    sectionDescription: "تغییرات بلافاصله ذخیره می‌شوند و برای اجراهای بعدی عامل اعمال می‌شوند.",
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "به عامل‌ها اجازه دهید ابزارها را در گردش‌کارهای فشرده و ایزوله‌شدهٔ JavaScript ترکیب کنند.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    heroTagline:
      "اپلیکیشن‌های همراه برای تلفن، ساعت، دسکتاپ و مرورگر شما — به‌همراه پلاگین‌هایی برای گسترش کارهایی که عامل شما می‌تواند انجام دهد.",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "از iOS گفتگو کنید، صحبت کنید، اقدامات را تأیید کنید و در OpenClaw به اشتراک بگذارید.",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "گفتگوهای یک‌نگاهی و پاسخ‌های سریع از روی مچ شما.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      chrome: {
        title: "افزونه Chrome",
        desc: "بگذارید OpenClaw Chrome موجود شما را هدایت کند — برگه‌ها، صفحه‌ها و فرم‌ها.",
      },
      plugins: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      displayName: "نام نمایشی",
      displayNameDescription: "به کاربران دیگر این gateway نمایش داده می‌شود.",
      ...
      avatarErrors: {
        invalid: "پردازش این تصویر امکان‌پذیر نبود.",
  ...
  board: {
    ...
    actionInProgress: "تغییر دیگری در داشبورد هنوز در حال ذخیره‌سازی است.",
    announcement: {
    ...
    widget: {
      cellLabel:
        "ابزارک داشبورد: {title}. برای پیمایش از کلیدهای جهت‌نما استفاده کنید. برای جابجایی، کلید Alt را نگه دارید و یک کلید جهت‌نما را فشار دهید.",
      ...
      appLoading: "در حال بازیابی اپ…",
      appStaleTitle: "این اپ سنجاق‌شده قدیمی است",
      ...
      frameAuthorizationFailed: "مجوز ویجت پس از تلاش‌های مکرر برای بازخوانی ناموفق بود.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable: "هنگام کار کردن عامل، تغییر شاخه در دسترس نیست.",
      branchSwitchRequiresAdmin: "تغییر شاخه نیازمند دسترسی مدیر اپراتور است.",
    ...
    board: {
      ...
      dockMenu: "پهلوگیری گفت‌وگو: {dock}",
      dockLeft: "پهلوگیری گفت‌وگو در چپ",
      dockRight: "پهلوگیری گفت‌وگو در راست",
      dockBottom: "پهلوگیری گفت‌وگو در پایین",
      dockHidden: "پنهان کردن گفت‌وگو",
      resizeDock: "تغییر اندازه پهلوگاه گفت‌وگو",
      reopenChat: "نمایش گفت‌وگو",
      defaultTab: "اصلی",
      mockPlaceholder: "درز نمای برد · {tabs} برگه · {widgets} ابزارک",
    ...
    composer: {
      ...
      microphoneAppliesNextSession: "تغییرات هنگام شروع جلسه بعدی Talk اعمال می‌شوند.",
      ...
      dictationAudioUnsupported: "Gateway قالب صوتی دیکته پشتیبانی‌نشده‌ای را برگرداند.",
    ...
    toolCards: {
      ...
      widgetExportRerender: "این ویجت باید برای خروجی گرفتن به‌صورت تصویر دوباره رندر شود.",
