...
export const nl: TranslationMap = {
  ...
  sessionsView: {
    ...
    viewArchived: "Gearchiveerde weergeven",
  ...
  custodian: {
    ...
    subtitleCaretaker: "Systeeminstelling en onderhoud.",
    exitSetup: "Instellen afsluiten",
    ...
    sessionRestarted:
      "{error} OpenClaw is een nieuwe sessie gestart; eerdere berichten blijven beschikbaar voor context.",
    ...
    nudge: {
      configReload: "Herladen van configuratie is gestopt — vraag me wat er is gebeurd",
      ...
      channelDegraded: "{channel} functioneert verminderd — vraag mij wat er is gebeurd",
  ...
  labsPage: {
    intro:
      "Labs bevat experimentele mogelijkheden die tussen releases kunnen veranderen, kapotgaan of verdwijnen.",
    sectionTitle: "Experimentele functies",
    sectionDescription:
      "Wijzigingen worden direct opgeslagen en zijn van toepassing op toekomstige agentruns.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Snelle blik op chats en snelle antwoorden vanaf je pols.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  board: {
    ...
    widget: {
      ...
      appStaleDetail:
        "De server, resource of oorspronkelijke transcriptie is niet langer beschikbaar.",
      retry: "Opnieuw proberen",
  ...
  chat: {
    ...
    board: {
      ...
      dockLeft: "Chat links plaatsen",
      dockRight: "Chat rechts plaatsen",
      dockBottom: "Chat onderaan plaatsen",
      dockHidden: "Chat verbergen",
      resizeDock: "Chatdock aanpassen",
    ...
    toolCards: {
      ...
      widgetExportFailed: "Widget-export mislukt. Probeer het opnieuw.",
