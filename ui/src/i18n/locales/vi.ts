...
export const vi: TranslationMap = {
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "Thông báo được ứng dụng OpenClaw hiển thị gốc trên máy Mac này.",
      ...
      nativeBlockedHint:
        "Thông báo đã bị tắt cho OpenClaw trong macOS. Hãy cho phép trong Cài đặt hệ thống > Thông báo.",
    },
    appearance: {
      theme: "Giao diện",
  ...
  custodian: {
    ...
    sessionRestarted:
      "{error} OpenClaw đã bắt đầu một phiên mới; các tin nhắn trước đó vẫn được giữ làm ngữ cảnh.",
  ...
  mcpServers: {
    ...
    targetInvalid: "Nhập URL cho transport HTTP hoặc dòng lệnh hợp lệ cho stdio.",
    ...
    configUnavailable: "Cấu hình không khả dụng; làm mới và thử lại.",
  ...
  labsPage: {
    ...
    sectionDescription:
      "Thay đổi được lưu ngay lập tức và áp dụng cho các lần chạy agent trong tương lai.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Điện thoại Android của bạn như một nút OpenClaw đầy đủ — trò chuyện, máy ảnh và Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "Xem nhanh các cuộc trò chuyện và trả lời nhanh từ cổ tay của bạn.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  board: {
    ...
    emptyHint: "Agent của bạn có thể ghim tiện ích tại đây — hãy thử yêu cầu một thẻ trạng thái.",
    ...
    widget: {
      ...
      rejectedDetail: "Widget này sẽ không hoạt động cho đến khi được gỡ bỏ hoặc thay thế.",
      ...
      actionErrorDetail: "Bảng điều khiển đã giữ lại trạng thái widget trước đó.",
  ...
  chat: {
    ...
    board: {
      ...
      defaultTab: "Chính",
      mockPlaceholder: "Đường ghép chế độ xem bảng · {tabs} tab · {widgets} widget",
    ...
    messages: {
      activity: "Hoạt động",
      forkFromHere: "Tách nhánh từ đây",
      hide: "Ẩn",
      hideConfirm: "Ẩn tin nhắn này trong trình duyệt này? Trợ lý vẫn nhìn thấy nó.",
      ...
      rewindUnavailable: "Không thể tua lại trong khi tác nhân đang làm việc",
      forkUnavailable: "Không thể phân nhánh trong khi tác nhân đang làm việc",
    ...
    composer: {
      ...
      dictationDisconnected: "Đọc chính tả đã dừng vì Gateway đã ngắt kết nối.",
      ...
      dictationReleaseToInsert: "Thả ra để chèn bản đọc chính tả",
