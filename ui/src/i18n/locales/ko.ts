...
export const ko: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "로그아웃되었습니다.",
      logoutNotCleared:
        "저장된 WhatsApp 세션이 삭제되지 않았습니다. 이미 없거나 인증 디렉터리를 수동으로 정리해야 할 수 있습니다.",
    },
  ...
  sessionsView: {
    ...
    deleteAllArchivedConfirm: "보관된 스레드 {count}개와 그 기록을 삭제하시겠습니까?",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      uploading: "처리 중…",
      profileHint:
        "JPEG, PNG 또는 WebP. 이미지는 가운데를 기준으로 자르고 512px로 크기가 조정됩니다.",
  ...
  custodian: {
    ...
    history: {
      ...
      opaqueChange: "표시된 구성 경로 변경 없이 서식 또는 주석이 변경되었습니다.",
      sources: {
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "에이전트가 컴팩트하고 샌드박스화된 JavaScript 워크플로에서 도구를 결합할 수 있도록 합니다.",
    },
    swarm: {
      title: "Swarm",
      description: "Code Mode가 서브에이전트 그룹을 병렬로 조율할 수 있도록 합니다.",
      empty: "활성 스웜이 없습니다.",
      defaultPhase: "단계 없음",
    },
  },
  ...
  appsPage: {
    ...
    heroTagline:
      "휴대폰, 시계, 데스크톱, 브라우저용 컴패니언 앱과 에이전트의 기능을 확장하는 플러그인을 제공합니다.",
    sectionMobile: "휴대폰에서",
    ...
    cards: {
      ...
      chrome: {
        ...
        desc: "OpenClaw가 기존 Chrome을 제어하게 하세요 — 탭, 페이지, 양식.",
      },
      plugins: {
        title: "플러그인 & ClawHub",
  ...
  profilePage: {
    ...
    identity: {
      title: "ID",
      description: "이 게이트웨이의 프로필입니다.",
      loading: "내 신원을 불러오는 중…",
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "대시보드 위젯: {title}. 화살표 키로 이동하세요. Alt 키를 누른 채 화살표 키를 누르면 이동할 수 있습니다.",
      moveHandle: "{title} 이동",
      ...
      appLoading: "앱 복원 중…",
      appStaleTitle: "고정된 이 앱은 오래되었습니다",
      ...
      frameAuthorizationFailed: "여러 번 새로고침을 시도했지만 위젯 인증에 실패했습니다.",
  ...
  chat: {
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "작성기 마이크 버튼을 누른 채 말한 다음 버튼을 놓으면 전송하지 않고 텍스트가 삽입됩니다.",
      ...
      dictationProviderUnavailable: "받아쓰기에 대한 전사 공급자가 구성되지 않았습니다.",
      dictationRecording: "녹음 중 {elapsed}",
      dictationReleaseToInsert: "받아쓰기를 삽입하려면 놓으세요",
