...
export const pt_BR: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Nenhuma sessão do WhatsApp armazenada foi limpa. Ela pode já estar ausente, ou seu diretório de autenticação pode precisar de limpeza manual.",
    },
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint:
        "JPEG, PNG ou WebP. As imagens são cortadas no centro e redimensionadas para 512px.",
  ...
  custodian: {
    ...
    history: {
      ...
      description: "O que mudou neste sistema, mais recentes primeiro.",
      ...
      opaqueChange:
        "Formatação ou comentários mudaram sem alterações visíveis no caminho de configuração.",
      sources: {
  ...
  mcpServers: {
    ...
    adminRequired: "Alterações no servidor MCP exigem acesso operator.admin.",
    enable: "Ativar",
    disable: "Desativar",
  ...
  labsPage: {
    ...
    sectionDescription:
      "As alterações são salvas imediatamente e se aplicam às futuras execuções do agente.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Aplicativos complementares para o seu celular, relógio, desktop e navegador — além de plugins para ampliar o que seu agente pode fazer.",
    ...
    badgeBundledIos: "Incluído com o aplicativo iOS",
    badgeBundledAndroid: "Incluído com o aplicativo Android",
    ...
    cards: {
      ...
      macos: {
        title: "macOS",
        desc: "Aplicativo na barra de menu para o seu Gateway — notificações, aprovações e conversas rápidas.",
      },
      windows: {
        title: "Windows",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "Copiado",
      branches: "Ramificações do tópico",
    ...
    board: {
      ...
      mockPlaceholder: "Seam da visão do board · {tabs} abas · {widgets} widgets",
    ...
    modelControls: {
      ...
      resetToDefault: "Restaurar para o padrão ({model})",
    },
    sideChat: {
      title: "Chat lateral",
    ...
    composer: {
      ...
      microphoneAppliesNextSession:
        "As alterações são aplicadas quando você iniciar sua próxima sessão de Fala.",
