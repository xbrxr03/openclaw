...
export const de: TranslationMap = {
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint:
        "JPEG, PNG oder WebP. Bilder werden zentriert zugeschnitten und auf 512 px skaliert.",
  ...
  configView: {
    ...
    sidebarPrefs: {
      title: "Seitenleiste",
      hint: "Legen Sie fest, was während laufender Sitzungen angezeigt wird.",
  ...
  custodian: {
    ...
    history: {
      ...
      empty: "Noch keine erfassten Änderungen.",
    ...
    nudge: {
      ...
      dismiss: "Diese Aktualisierung ausblenden",
    },
  },
  mcpServers: {
    ...
    targetInvalid: "Gib eine URL für HTTP-Transporte oder eine gültige Befehlszeile für stdio ein.",
    ...
    adminRequired: "Änderungen am MCP-Server erfordern operator.admin-Zugriff.",
  ...
  mcpPage: {
    connectorsLink: "Entdecke One-Click-Konnektoren auf der Plugins-Seite.",
    servers: "Server",
    oauth: "OAuth",
    filtered: "Gefiltert",
  ...
  labsPage: {
    intro:
      "Labs enthält experimentelle Funktionen, die sich zwischen Releases ändern, brechen oder verschwinden können.",
    ...
    codeMode: {
      title: "Code Mode",
      description: "Lass Agenten Tools in kompakten, sandboxed JavaScript-Workflows kombinieren.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    heroTagline:
      "Begleit-Apps für dein Handy, deine Uhr, deinen Desktop und Browser – plus Plugins, um die Fähigkeiten deines Agenten zu erweitern.",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chatten, sprechen, Aktionen genehmigen und Inhalte von iOS in OpenClaw teilen.",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Auf einen Blick erfassbare Chats und schnelle Antworten von deinem Handgelenk.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatarErrors: {
        ...
        sourceTooLarge: "Wähle ein Bild mit 10 MB oder kleiner.",
  ...
  board: {
    ...
    emptyHint: "Dein Agent kann hier Widgets anheften – frag einfach nach einer Statuskarte.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin:
        "Zum Wechseln des Branchs sind Operator-Admin-Rechte erforderlich.",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Halte die Mikrofonschaltfläche im Editor gedrückt, sprich und lass dann los, um Text einzufügen, ohne ihn zu senden.",
      ...
      dictationFinalizationTimedOut:
        "Diktat gestoppt, bevor das letzte Teiltranskript finalisiert werden konnte.",
      ...
      selectedCameraUnavailable:
        "Die ausgewählte Kamera ist nicht verfügbar. Wählen Sie eine andere Kamera oder die Systemstandardeinstellung.",
    ...
    sessionDiscussion: {
      ...
      requiresWriteAccess:
        "Zum Öffnen dieser Diskussion ist Schreibzugriff als Operator erforderlich.",
