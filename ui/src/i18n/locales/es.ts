...
export const es: TranslationMap = {
  ...
  configView: {
    ...
    sidebarPrefs: {
      title: "Barra lateral",
      hint: "Elige lo que aparece mientras hay sesiones en ejecución.",
  ...
  custodian: {
    ...
    history: {
      ...
      opaqueChange:
        "Cambió el formato o los comentarios sin cambios visibles en las rutas de configuración.",
      sources: {
  ...
  labsPage: {
    ...
    swarm: {
      title: "Swarm",
      description: "Permite que el Modo de código organice grupos de subagentes en paralelo.",
  ...
  profilePage: {
    ...
    identity: {
      ...
      displayName: "Nombre para mostrar",
      displayNameDescription: "Visible para otras personas que usan este gateway.",
  ...
  chat: {
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Mantén presionado el botón del micrófono del compositor, habla y suelta para insertar texto sin enviarlo.",
    ...
    sessionDiscussion: {
      ...
      unavailable: "Este debate no se puede insertar.",
    },
    workspaceFiles: {
