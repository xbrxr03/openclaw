...
export const fr: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Aucune session WhatsApp enregistrée n'a été effacée. Elle est peut-être déjà absente, ou son répertoire d'authentification nécessite peut-être un nettoyage manuel.",
    },
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivityHint:
        "Affiche la dernière activité de l'assistant ou de l'outil sous les sessions en cours.",
    },
    connection: {
      title: "Connexion",
      gateway: "Gateway",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Mode Code",
      description:
        "Laissez les agents combiner des outils dans des workflows JavaScript compacts et isolés.",
    },
    swarm: {
      title: "Swarm",
      description: "Laissez le Mode Code orchestrer des groupes de sous-agents en parallèle.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Discussions consultables d'un coup d'œil et réponses rapides depuis votre poignet.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatarErrors: {
        invalid: "Impossible de traiter cette image.",
  ...
  chat: {
    ...
    board: {
      ...
      mockPlaceholder: "Aperçu de la vue tableau · {tabs} onglets · {widgets} widgets",
      mockOverview: "Aperçu",
    ...
    composer: {
      ...
      cameraPageInactive: "Les caméras sont indisponibles tant que cette page est inactive.",
      ...
      microphoneAppliesNextSession:
        "Les modifications s'appliqueront lorsque vous démarrerez votre prochaine session Talk.",
      ...
      selectedCameraUnavailable:
        "La caméra sélectionnée est indisponible. Choisissez une autre caméra ou le paramètre par défaut du système.",
    ...
    toolCards: {
      ...
      widgetExportRerender: "Ce widget doit être régénéré pour l'exporter en tant qu'image.",
    ...
    sessionDiscussion: {
      ...
      requiresWriteAccess: "L'accès en écriture opérateur est requis pour ouvrir cette discussion.",
