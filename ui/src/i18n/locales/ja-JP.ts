...
export const ja_JP: TranslationMap = {
  ...
  custodian: {
    ...
    nudge: {
      configReload: "構成の再読み込みが停止しました — 何が起きたか私に聞いてください",
      channelAuth: "{channel} の認証が低下しました — 何が起きたか私に聞いてください",
      channelDisconnected: "{channel} が切断されました — 何が起きたか私に聞いてください",
      channelDegraded: "{channel} が低下しています — 何が起きたか私に聞いてください",
  ...
  mcpServers: {
    ...
    configUnavailable: "構成を利用できません。更新してもう一度お試しください。",
  ...
  labsPage: {
    intro:
      "Labsには、リリース間で変更、破損、または削除される可能性がある実験的な機能が含まれています。",
    sectionTitle: "実験的な機能",
  ...
  appsPage: {
    ...
    heroTagline:
      "スマートフォン、時計、デスクトップ、ブラウザ向けのコンパニオンアプリと、エージェントの機能を拡張するプラグイン。",
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Android スマートフォンを完全な OpenClaw ノードとして利用 — チャット、カメラ、Canvas。",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "手首でひと目でわかるチャットとクイック返信。",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Androidコンパニオンで、OpenClawをスマートウォッチに拡張します。",
      },
      macos: {
        title: "macOS",
      ...
      windows: {
        title: "Windows",
        desc: "Windowsコンパニオンで、PCをOpenClawノードとして接続します。",
      },
      linux: {
        title: "Linux",
  ...
  profilePage: {
    ...
    identity: {
      title: "アイデンティティ",
      description: "このゲートウェイでのあなたのプロフィール。",
      loading: "あなたのIDを読み込み中…",
      profileUnavailable: "あなたのIDプロフィールを読み込めませんでした。",
      avatar: "アバター",
      avatarDescription: "PNG、JPEG、またはWebP。画像は256 × 256以下にリサイズされます。",
      chooseAvatar: "画像を選択",
      processingAvatar: "処理中…",
      displayName: "表示名",
      displayNameDescription: "このgatewayを使用している他の人に表示されます。",
  ...
  board: {
    ...
    emptyHint:
      "エージェントはここにウィジェットをピン留めできます — ステータスカードを頼んでみてください。",
    ...
    widget: {
      cellLabel:
        "ダッシュボードウィジェット: {title}。矢印キーで移動します。Altキーを押しながら矢印キーを押すと移動できます。",
      ...
      rejectedDetail: "このウィジェットは削除または置換されるまで非アクティブのままになります。",
      appLoading: "アプリを復元中…",
      ...
      errorDetail: "この問題はこのカード内に限定されています。",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "コピーしました",
      branches: "スレッドのブランチ",
      branchSwitchUnavailable: "エージェントの作業中はブランチを切り替えできません。",
    ...
    board: {
      ...
      resetDescription: "会話のコンテキストがリセットされます。ダッシュボードは保持されます。",
    },
    catalog: {
    ...
    composer: {
      ...
      cameraInput: "カメラ",
      cameraListUnsupported: "このブラウザーはカメラの一覧を取得できません。",
      ...
      holdToRecordSettingDescription:
        "作成欄のマイクボタンを長押しして話し、離すと送信せずにテキストが挿入されます。",
      dictationAudioUnsupported:
        "Gatewayがサポートされていない音声入力の音声フォーマットを返しました。",
      dictationBrowserAudioUnsupported:
        "このブラウザーは8 kHzで音声入力の音声をキャプチャできません。",
      ...
      dictationFinalizationTimedOut:
        "最後の途中経過の文字起こしを確定する前に音声入力が停止しました。",
      ...
      selectedCameraUnavailable:
        "選択したカメラは使用できません。別のカメラまたはシステムデフォルトを選択してください。",
